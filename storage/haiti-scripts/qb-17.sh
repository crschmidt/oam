...
MYPATH=/mnt/geothumper/data/Haiti/digitalglobe/Quickbird/Post-Event/052301115010_01/052301115010_01_P001_PSH
DEST=/storage/data/haiti/processed/dglobe/quickbird-17
mkdir -p $DEST
chmod 777 $DEST
cd $MYPATH
for i in *.TIF; do
