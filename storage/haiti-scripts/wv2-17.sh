...
MYPATH=/mnt/geothumper/data/Haiti/digitalglobe/Worldview-2/Post-Event/052301091020_01/052301091020_01_P001_PSH
DEST=/storage/data/haiti/processed/dglobe/worldview-17
mkdir -p $DEST
chmod 777 $DEST
cd $MYPATH
for i in *.TIF; do
