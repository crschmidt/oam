...
MYPATH=/storage/data/haiti/source/digitalglobe/Worldview-2/052301567010_01/052301567010_01_P001_PSH
DEST=/storage/data/haiti/processed/dglobe/worldview-20
mkdir -p $DEST
chmod 777 $DEST
cd $MYPATH
for i in *.TIF; do
